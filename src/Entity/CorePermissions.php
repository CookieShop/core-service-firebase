...
class CorePermissions
{
    ...
    /**
     * @var \Adteam\Core\Service\Firebase\CoreResources
     *
     * @ORM\ManyToOne(targetEntity="Adteam\Core\Service\Firebase\CoreResources")
     * @ORM\JoinColumns({
     ...
     * Set resource
     *
     * @param \Adteam\Core\Service\Firebase\CoreResources $resource
     *
     * @return CorePermissions
     */
    public function setResource(\Adteam\Core\Service\Firebase\CoreResources $resource = null)
    {
     ...
     * Get resource
     *
     * @return \Adteam\Core\Service\Firebase\CoreResources
     */
