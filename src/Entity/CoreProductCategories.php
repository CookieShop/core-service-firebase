...
class CoreProductCategories
{
     ...
     * Set parent
     *
     * @param \Adteam\Core\Service\Firebase\CoreProductCategories $parent
     *
     * @return CoreProductCategories
     */
    public function setParent(\Adteam\Core\Service\Firebase\CoreProductCategories $parent = null)
    {
        $this->parent = $parent;
